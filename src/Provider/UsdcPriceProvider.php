...
class UsdcPriceProvider implements CryptoPriceProviderInterface
{
    ...
    {
        // If the code is USD, return 1 as USDC is pegged to USD
        if ($code === 'USD') {
            return 1;
        }
    ...
    /**
     * Rounds the price to the defined USDC round places.
     *
     * @param float $price
     * @return float
     */
    ...
    {
        return round($price, self::USDC_ROUND_PLACES, PHP_ROUND_HALF_UP);
    }
}